...
from pyflickr.core.request import Accessor, OAuth
...
if __name__ == "__main__":
    ...
    api_key = "28d7709a4ca68118d501e26cc4f8684e"
    api_secret = "f2d0aa09d1c5314e"
    oauth = OAuth(api_key, api_secret).auth()
    ...
    for min_date, max_date in date_manager:
        ...
        notice = True
        accessor = Accessor(queue, notice, payload, oauth)
